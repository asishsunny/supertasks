export default function Controls() {
  return <div className="flex gap-0 h-8 items-center relative shrink-0 w-full">
        <div className="bg-ui-bg-segment-control flex gap-0.5 items-center p-0.5 rounded-lg shrink-0"><button className="text-ui-fg-subtle px-2.5 py-1 rounded-md txt-compact-small cursor-pointer">Kanban</button><button className="bg-ui-bg-base text-ui-fg-base shadow-elevation-card-rest px-2.5 py-1 rounded-md txt-compact-small cursor-pointer">List</button></div>
