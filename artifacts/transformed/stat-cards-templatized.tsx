export default function StatCards() {
  return <div className="flex gap-4 items-start relative shrink-0 w-full">
        <div className="bg-ui-bg-base flex flex-1 flex-col gap-4 min-w-[1px] overflow-clip p-6 relative rounded-xl shadow-elevation-card-rest text-ui-fg-base" data-repeat="4" data-repeat="2">
