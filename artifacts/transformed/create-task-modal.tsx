export default function CreateTaskModal() {
  return <div className="bg-ui-bg-base flex flex-col overflow-clip relative rounded-[12px] shadow-elevation-card-rest shrink-0 w-[480px]">
        ...
        <div className="flex flex-col gap-5 p-6 relative shrink-0 w-full">
          <div className="flex gap-4 items-start relative shrink-0 w-full">
            <div className="flex flex-1 flex-col gap-1.5 min-w-[1px]"><Label size="small">Priority</Label><Select size="small" placeholder="Select" /></div>
          ...
          <div className="flex gap-4 items-start relative shrink-0 w-full">
            <div className="flex flex-1 flex-col gap-1.5 min-w-[1px]"><Label size="small">Assignee</Label><Select size="small" placeholder="Select" /></div>
