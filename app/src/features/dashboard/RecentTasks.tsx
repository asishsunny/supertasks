...
export function RecentTasks() {
  ...
  const columns: Column<Task>[] = useMemo(() => [
    { header: "Task", render: (t) => <span className="txt-compact-small text-ui-fg-base">{t.title}</span> },
  ...
  return (
    <div className="bg-ui-bg-base rounded-xl shadow-elevation-card-rest overflow-clip w-full">
