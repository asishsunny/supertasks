      ...
      <div className="bg-ui-bg-base flex flex-col overflow-clip py-2 relative rounded-[8px] shadow-elevation-card-rest shrink-0 w-[240px]">
        {navItems.map((item) => (
          <div
            ...
            className={
              item.active
                ? "bg-ui-bg-subtle border-ui-fg-base border-l-2 flex items-center px-4 py-2.5 relative shrink-0 w-full cursor-pointer"
                : "flex items-center px-4 py-2.5 relative shrink-0 w-full cursor-pointer"
            }
