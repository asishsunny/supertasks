...
// step 2: adapted from artifacts/transformed/controls.tsx

import { Button, Badge, Input, Label, Textarea, Select, Avatar, IconButton, Kbd } from "@medusajs/ui";
  ...
  return (
    <div className="flex gap-0 items-center relative w-full h-full">
      <div className="bg-ui-bg-segment-control flex gap-0.5 items-center p-0.5 rounded-lg shrink-0">
        <button className="segment-tab">Kanban</button>
        <button className="segment-tab">List</button>
      </div>
