export default function SettingsContent() {
  return <div className="flex gap-6 items-start relative w-full h-full">
      <div className="bg-ui-bg-base flex flex-col overflow-hidden py-2 relative rounded-[8px] shadow-elevation-card-rest shrink-0 w-[200px]">
      ...
      <div className="bg-ui-bg-base flex flex-1 flex-col min-w-[1px] overflow-hidden relative rounded-[8px] shadow-elevation-card-rest">
        ...
        <div className="flex flex-col gap-5 p-6 relative shrink-0 w-full">
          ...
          <div className="flex gap-4 items-start relative shrink-0 w-full" data-repeat="3">
            <div className="flex flex-1 flex-col gap-1.5 min-w-[1px]" data-repeat="2"><div /><Input size="small" className="w-full" defaultValue="Ludvig Rask" /></div>
            
          </div>
          
          
          <div className="flex flex-1 flex-col gap-1.5 min-w-[1px]"><div /><textarea className="bg-ui-bg-field min-h-[80px] overflow-clip px-2 py-1.5 rounded-md shadow-borders-base w-full text-ui-fg-muted txt-small resize-none" placeholder="Placeholder" /></div>
