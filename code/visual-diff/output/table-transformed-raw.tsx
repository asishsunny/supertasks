export default function RecentTasks() {
  return <div className="bg-ui-bg-base flex flex-col gap-0 overflow-clip p-0 relative rounded-xl shadow-elevation-card-rest w-full h-full">
      ...
      <div className="flex flex-col relative shrink-0 w-full">
        <div className="bg-ui-bg-subtle flex gap-3 h-12 items-center justify-center relative shrink-0 w-full px-6">
          <div className="flex flex-1 h-full items-center min-w-[1px] relative">
            <p className="relative shrink-0 text-ui-fg-subtle txt-compact-small-plus">
              Task
            </p>
          </div>
          <div className="flex h-full items-center relative shrink-0 w-[160px]">
            <p className="relative shrink-0 text-ui-fg-subtle txt-compact-small-plus">
              Assignee
            </p>
          </div>
          <div className="flex h-full items-center relative shrink-0 w-[120px]">
            <p className="relative shrink-0 text-ui-fg-subtle txt-compact-small-plus">
              Priority
            </p>
          </div>
          <div className="flex h-full items-center relative shrink-0 w-[130px]">
            <p className="relative shrink-0 text-ui-fg-subtle txt-compact-small-plus">
              Due Date
            </p>
          </div>
          <div className="flex h-full items-center relative shrink-0 w-[140px]">
            <p className="relative shrink-0 text-ui-fg-subtle txt-compact-small-plus">
              Status
            </p>
          </div>
        ...
        <div className="bg-ui-bg-base flex gap-3 h-12 items-center justify-center px-6 relative shrink-0 w-full">
          <div className="flex flex-1 h-full items-center min-w-[1px] relative">
            <p className="relative shrink-0 text-ui-fg-base txt-compact-small">
              Icon system audit
            </p>
          </div>
          <div className="flex gap-2 h-full items-center relative shrink-0 w-[160px]">
          ...
          <div className="flex h-full items-center relative shrink-0 w-[130px]">
            <p className="relative shrink-0 text-ui-fg-error txt-compact-small">
              May 7, 2026
            </p>
          </div>
          <div className="flex gap-1 h-full items-center relative shrink-0 w-[140px]">
