...
4. Run: node ${ROOT}/code/pipeline/split-gallery-cache.mjs <saved-file-path>
...
cd ${ROOT} && node code/pipeline/build-pipeline.mjs --force 2>&1
...
cd ${ROOT} && node code/pipeline/build-pipeline.mjs --phase scorecard 2>&1
...
cd ${ROOT} && node code/pipeline/build-pipeline.mjs --phase diff 2>&1
