...
// ── Nav icon swap IDs (ds-contract.md §7) ───────────────────────────────────
const NAV_ICONS = {
  Dashboard: '4071:4623',
  Tasks:     '4071:2407',
  Team:      '4071:2411',
...
// Font: ds-contract.md §6
await figma.loadFontAsync({ family: 'Geist', style: 'Regular' });

// Variable import fallback (playbook §6)
const V = async (id) => {
...
// Walk sidebar internal structure: Sidebar > Sidebar > Top > Menu
...
// Extensions section — show Settings at bottom, hide rest
...
// Action icons: hide bell, swap cog to moon
...
// Breadcrumb — set page title, hide levels 2 and 3
...
// CTA button (ds-contract.md §2 — Button prop keys)
