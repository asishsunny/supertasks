// comp-team-invite-snippet.js — Team + Invite Modal composition (1440×900)
// Clones existing "Team" frame, layers: base → scrim → modal (centered).

// ── DATA ──
const DATA = {
  baseName: 'Team',
  modalName: 'Invite Team Member',
  compName: 'Team — Invite',
  pageW: 1440,
  pageH: 900,
};
